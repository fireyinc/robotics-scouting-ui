    ...
    <div class="content">
      <div class="maincontainer">
        ...
        <div class="maindatacont">
          <div class="teamtable">
            <span style="font-size: 20pt; font-weight: bold;">Team Stats</span>
  ...
  methods: {
        ...
        data: {
          ...
          datasets: [{
            ...
            [
              ...
              100-Math.round(Math.abs(this.teamstats.teamavgclimbtime/this.teamstats.climbavg-this.minclimbtime)/Math.abs(this.maxclimbtime-this.minclimbtime)*100),
    ...
    getallteamdata() {
      ...
      teams.forEach(team => {
        ...
        climbtimes.push(Math.round(avgclimbtime)/clavgs.toFixed(2))
